...
public final class ForgeHydraulicBlockRegistry {
    ...
    public static final RegistryObject<Block> OCEAN_REFILL_SUPPRESSOR = BLOCKS.register(
    ...
    public static final RegistryObject<BlockEntityType<OceanRefillSuppressorBlockEntity>> OCEAN_REFILL_SUPPRESSOR_BLOCK_ENTITY = BLOCK_ENTITY_TYPES.register(
        "ocean_refill_suppressor",
        () -> BlockEntityType.Builder.of(
