...
public final class SpringBiomeProfile {
    ...
    public static float waterBias(Holder<Biome> biome) {
        ...
        if (FFFluidUtils.isRiverBiome(biome)) bias += 0.32F;
        if (FFFluidUtils.isBeachBiome(biome)) bias += 0.18F;
        if (FFFluidUtils.isOceanBiome(biome)) bias += 0.10F;
    ...
    public static float lavaBias(Holder<Biome> biome) {
        ...
        if (FFFluidUtils.isRiverBiome(biome)) bias -= 0.24F;
        if (FFFluidUtils.isBeachBiome(biome) || FFFluidUtils.isOceanBiome(biome)) bias -= 0.16F;
